...
vals = ['adm', 'ddpm', 'iddpm', 'ldm', 'pndm', 'vqdiffusion', 'sdv1_new', 'sdv2']
multiclass = [1, 1, 1, 1, 1, 1, 1, 1]
# Running tests
opt = TestOptions().parse(print_options=False)
# opt.dataroot = '/opt/data/private/tcc/data/data/DIRE_images/dire_bedroom/'

opt.model_path = "checkpoints/4class-resnet_car_cat_chair_horse_bs32___2023_10_22_10_54_55__lnum_64__seed_100__Durall/model_epoch_Acc_66.01454308398537_epoch_67_steps306068.pth"
# opt.dataroot = '/opt/data/private/tcc/data/data/Data_LiuHuan/iccv23diffusion/test/'
