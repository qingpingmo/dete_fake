...
import numpy as np
from networks.f3net import F3Net
...
opt.model_path = 'checkpoints/4class-resnet_car_cat_chair_horse_bs128___2023_02_04_22_46_07/model_epoch_99.pth'
opt.loadSize = 299
opt.batch_size = 32
...
model = F3Net(num_classes=1, img_width=299, img_height=299)
