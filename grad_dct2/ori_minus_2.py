...
class ProGAN_Dataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        new_feature_image = self._process_image(image)  # Process to generate new feature image

        if self.transform:
            image = self.transform(image)  # Transform original image
            new_feature_image = self.transform(new_feature_image)  # Transform new feature image
