...
class ProGAN_Dataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        # Check if the dataset instance is for validation and if the image is already a 'new feature' image
        if self.is_validation and 'new_feature' in img_path:
            new_feature_image = image  # Use the same image as its new feature counterpart
        else:
